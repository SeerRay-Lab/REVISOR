...
def apply_monkey_patch(model: PreTrainedModel, ulysses_sp_size: int):
    ...
    if model.config.model_type in ("qwen2_vl", "qwen2_5_vl"):  # patch remove padding for qwen2vl mrope
        try:
            from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLFlashAttention2 as qw25vlattn
            from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLFlashAttention2 as qw2vlattn
        except:
            from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLAttention as qw25vlattn
            from transformers.models.qwen2_vl.modeling_qwen2_vl import Qwen2VLAttention as qw2vlattn

        from verl.models.transformers.qwen2_vl import ulysses_flash_attn_forward

        qw25vlattn.forward = ulysses_flash_attn_forward
        qw2vlattn.forward = ulysses_flash_attn_forward
