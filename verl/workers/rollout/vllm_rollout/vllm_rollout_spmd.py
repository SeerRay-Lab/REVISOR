...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if 'intermediate_raw_prompt' in non_tensor_batch.keys():
            non_tensor_batch.pop('intermediate_raw_prompt')
        if 'intermediate_raw_prompt_ids' in non_tensor_batch.keys():
             non_tensor_batch.pop('intermediate_raw_prompt_ids')
