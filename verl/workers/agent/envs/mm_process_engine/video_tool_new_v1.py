...
class VideoToolNEWV1(ToolBase):
    name = "video_tool_new_v1"
    ...
    def execute(self, action_string: str, eval_mode=False, **kwargs) -> tuple:
        """
        ...
        try:
            ...
            if interval is None or not interval or end_time - start_time < 2:
            ...
            ele = {
                ...
                "video_end": end_time,
                "fps": 2,  # Number of frames to sample
                "min_pixels": 6272,
                "max_pixels": 200704,
                "min_frames": 4,
                "max_frames": 512,
