...
class VideoToolV1(ToolBase):
    ...
    def validate_interval(self, start_time: float, end_time: float) -> bool:
        try:
            ...
            assert time_interval > 1, f"time interval should be greater than 1 second: {start_time=} {end_time=}"
            return True
...
if __name__ == "__main__":
    ...
    tool = VideoToolV1("video_tool_v1", "Tool for video zooming", {})
