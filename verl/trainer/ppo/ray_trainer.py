    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                if 'intermediate_raw_prompt' in batch.non_tensor_batch.keys():
                    gen_batch.non_tensor_batch['intermediate_raw_prompt'] = batch.non_tensor_batch.pop('intermediate_raw_prompt')
                    gen_batch.non_tensor_batch['intermediate_raw_prompt_ids'] = batch.non_tensor_batch.pop('intermediate_raw_prompt_ids')
